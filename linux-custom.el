...
(custom-set-variables
 ...
 '(package-selected-packages
   '(company-ycmd ycmd alert magit-todos dumb-jump ob-restclient ivy-xref ivy-rich deadgrep auto-virtualenvwrapper counsel counsel-gtags counsel-projectile counsel-pydoc night-owl-theme ggtags restclient spinner lsp-imenu company-lsp lsp-ui lsp-mode
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "PragmataPro Mono" :foundry "fsdf" :slant normal :weight normal :height 100 :width normal))))
