...
(custom-set-variables
 ...
 '(flycheck-flake8rc "~/.config/flake8" t)
 '(flycheck-python-flake8-executable "~/.local/bin/flake8" t)
 ...
 '(package-selected-packages
   '(auto-virtualenvwrapper counsel counsel-gtags counsel-projectile counsel-pydoc night-owl-theme ggtags restclient spinner lsp-imenu company-lsp lsp-ui lsp-mode
