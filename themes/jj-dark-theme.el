...
(let ((black "#161616")
  ...
  (apply 'custom-theme-set-faces 'jj-dark
	 `(font-lock-function-name-face ((t (:font "SF Mono Medium" :height 120 :slant normal :weight normal))))
	 `(font-lock-comment-face ((t (:font "SF Mono Medium" :height 120 :slant normal :weight normal))))
	 `(font-doc-face ((t (:font "SF Mono Medium" :height 120 :slant normal :weight normal))))
	 `(font-lock-warning-face ((t (:foreground ,white :background ,black :font "SF Mono Medium" :height 120 :slant normal :weight bold))))
	 `(mode-line ((t (:foreground ,black :background ,white :box nil :font "SF Mono Medium" :height 120 :slant normal :weight normal))))
	 `(mode-line-inactive ((t (:foreground ,black :background ,white :box nil :font "SF Mono Medium" :height 120 :slant normal :weight light))))
	 ...
	 `(popup-tip-face ((t (:background ,white :foreground ,black :bold t :font "SF Mono Medium" :height 120))))
	 ;; company
	 `(company-preview ((t (:foreground ,white :underline t :font "SF Mono" :height 120))))
	 ...
	 `(company-tooltip ((t (:background ,black :foreground ,white :font "SF Mono Medium" :height 120))))
	 `(company-tooltip-common ((((type x)) (:inherit company-tooltip :weight bold)) (t (:inherit company-tooltip))))
	 `(company-tooltip-common-selection ((((type x)) (:inherit company-tooltip-selection :weight bold)) (t (:inherit company-tooltip-selection))))
	 `(company-tooltip-selection ((t (:background ,white :foreground ,black :font "SF Mono Medium" :height 120))))
	 ;; eshell
	 `(eshell-prompt ((t (:inherit default))))
	 `(font-lock-warning-face ((t (:foreground ,black :bold t :underline t))))
	 (mapcar (lambda (n) `(,n ((t (:background ,black :foreground ,white :font "SF Mono Medium" :height 120 :width normal :weight normal))))) jj-faces)))
