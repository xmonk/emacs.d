...
(custom-set-variables
 ...
 '(magit-repository-directories
   '(("~/w/vivial/moosetalk-web")
     ("~/w/vivial/moosetalk-infra")
     ("~/.dotfiles")
     ("~/.emacs.d/" . 0)
     ("~/.emacs.d/lib/" . 1)))
